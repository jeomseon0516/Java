...
public class ArrayTest {
	public static void main(String[] args) {
		...
		System.out.println("arr1 다섯번째 원소 : " + arr1[4]);
		...
		// 1차원 배열
		int[] scores = { 80, 60, 75, 62, 90 }; // 배열명은 복수형 네이밍
		...
		System.out.println("arrd3d[0][0][0] : " + arr3d[0][0][0]);
		System.out.println("arrd3d[0][1][1] : " + arr3d[0][1][1]);
		System.out.println("arrd3d[0][2][2] : " + arr3d[0][2][2]);
		System.out.println("arrd3d[1][1][2] : " + arr3d[1][1][2]);
		System.out.println("arrd3d[1][2][1] : " + arr3d[1][2][1]);
		System.out.println("arrd3d[2][1][1] : " + arr3d[2][1][1]);
		System.out.println("arrd3d[2][2][2] : " + arr3d[2][2][2]);
